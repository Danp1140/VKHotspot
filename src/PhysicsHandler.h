...
public:
	...
	glm::vec3 getMomentum() const {return dp * m;}
...
private:
	...
	glm::quat r, dr, ddr;
	float m;
	// consider a bounciness uint8_t, where 0 is complete absorption and 255 is completely reversed velocity
...
typedef std::function<void()> CollisionFunc;

class ColliderPair {
public:
	ColliderPair() : c1(nullptr), c2(nullptr), f(COLLIDER_PAIR_FLAG_NONE), cf(nullptr) {}
...
private:
	...
	void collidePointPoint();
	void collidePointMesh();
	void collideMeshMesh();
};
